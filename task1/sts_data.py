...
class STSData:
    ...
    def get_data_loader(self, batch_size=8):
        ...
        # creating a dictionary of dataloaders
        ...
        for key, df in df_dict.items():
            ...
            # fetching list of raw sentences
            sent_A_raw, sent_B_raw = df['sentence_A'].values, df['sentence_B'].values

            # numericalizing tokens i.e. replacing tokens with their respective indices in vocabulary
            ...
            # preparing datasets for each split
            if(key == 'train'):
        ...
        # preparing dataloaders for each split
